...
nnoremap <Leader>] :<C-u>LspDefinition<CR>
nnoremap <Leader>[ :<C-u>LspReferences<CR>
...
nnoremap <Leader>z :<C-u>LspDocumentFormat<CR>
xnoremap <Leader>z :<C-u>LspDocumentRangeFormat<CR>
