...
#######################################################################################################################
IMAGE_NAME = imokuri123/{{_input_:container_name}}
IMAGE_TAG = v0.0.1

.PHONY: build-{{_input_:container_name}}
build-{{_input_:container_name}}: ## Build {{_input_:container_name}}.
	docker build -t $(IMAGE_NAME):$(IMAGE_TAG) -f Dockerfile .

.PHONY: push-{{_input_:container_name}}
push-{{_input_:container_name}}: ## Push {{_input_:container_name}}.
	docker push $(IMAGE_NAME):$(IMAGE_TAG)

.PHONY: run-{{_input_:container_name}}
...
.PHONY: up-{{_input_:container_name}}
...
.PHONY: down-{{_input_:container_name}}
